...
## Scope
Reviewed all 12 current repository userscripts: ten main SakaLuX scripts, Apocalypse Poker Exit Alert and the experimental Stock Manager. Historical backups were not treated as installable releases.
...
| Apocalypse-Poker-Exit-Alert.user.js | 0.7.2 (unchanged) |
