...
(() => {
  'use strict';
  const SELF={id:'bazaar',name:'Bazaar Thanker',icon:'💬',selector:'#sakalux-bt-settings-button',fallback:'https://www.torn.com/page.php?sid=events',version:'5.3.13'};
