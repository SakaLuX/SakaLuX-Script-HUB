...
`;
    ...
    const HUB_CHANGELOG = [
        {"version": "1.9.73", "date": "2026-09-18", "changes": ["Synchronizes Stocks v0.8.7 and Elimination v1.3.44 performance details and offline fallback.", "Updates cached Stocks NEW details without replacing saved module preferences."]},
