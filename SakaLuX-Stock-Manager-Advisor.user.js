...
`;
  ...
  const SELF=Object.assign({"id":"stock-manager-advisor","name":"Stocks","icon":"📊","selector":"#sakalux-module-bridge-stock-manager-advisor","fallback":"https://www.torn.com/page.php?sid=stocks"},{version:'0.8.14'});
...
`;
  ...
  async function init() {
    ...
    const mo=new MutationObserver(records=>{
      ...
      const own='#slx-stock-panel,#slx-stock-inline,#slx-stock-open,#slx-stock-panic,.slx-stock-row-tools,[id^="sakalux-module-bridge-"],[data-slx-standalone-registration]';
      managerLauncher();
