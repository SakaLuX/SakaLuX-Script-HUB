...
(() => {
  'use strict';
  const SELF=Object.assign({"id":"elimination-assistant","name":"Elimination","icon":"⚔️","selector":"#slx-elim-btn","fallback":"https://www.torn.com/page.php?sid=elimination"},{version:'1.3.27'});
