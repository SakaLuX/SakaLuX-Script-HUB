...
(function () {
    ...
    function parseResponse(
        ...
        try {
            ...
            throw new Error(
                'Invalid JSON returned by Torn API.'
            );
        }
    }
    ...
    async function ensureCatalogue(
        ...
        if (
            ...
            throw new Error(
                'Item catalogue returned no items.'
            );
        }
    ...
    async function refreshData(
        ...
        try {
            ...
            for (
                ...
                const url =
                    'https://api.torn.com/v2/user/inventory' +
                    '?cat=' +
                    encodeURIComponent(
                        category
                    ) +
    ...
    function injectCss() {
        ...
        style.textContent = `
            ...
            #sl-eg-panel.compact .sl-eg-row{
                padding:6px;
                margin-bottom:4px
            }

            #sl-eg-panel.compact .sl-eg-icon{
                width:25px;
                height:25px
            }

            #sl-eg-panel.compact .sl-eg-name{
                font-size:12px
            }

            #sl-eg-panel.compact .sl-eg-category{
                display:none
            }
            ...
            >
                ...
                <div id="sl-eg-header">
                    ...
                    >
                        ...
                        <select id="sl-eg-auto">
                            <option value="0">Auto refresh OFF</option>
                            <option value="5">Auto refresh 5m</option>
                            <option value="10">Auto refresh 10m</option>
                            <option value="30">Auto refresh 30m</option>
                        </select>

                    </div>

                    <div id="sl-eg-filters">
                ...
                <div class="sl-eg-footer">
                    Read-only
                    • Relics excluded from value
                    • ⭐ = priority
                </div>
    ...
    function showKeyPrompt() {
        ...
        list.innerHTML = `
            <div class="sl-eg-error">
                ...
                <b>
                    🔑 Minimal API Key required
                </b>

                <br><br>

                Torn PDA should inject it automatically.
    ...
    function render() {
        ...
        if (
            ...
            stats.innerHTML = `
                <div class="sl-eg-stat">
                    <div class="sl-eg-stat-value">
                        ⏳
                    </div>

                    <div class="sl-eg-stat-label">
                        STATUS
                    </div>
                </div>
            `;
        ...
        stats.innerHTML = `
            <div class="sl-eg-stat">
                ...
                <div class="sl-eg-stat-value">
                    ${ownedEnhancers}/${ENHANCERS.length}
                </div>
        ...
        for (
            ...
            html += `
                ...
                >
                    ...
                    <div class="sl-eg-icon">
                        ${icon}
                    </div>

                    <div>

                        <div class="sl-eg-name">
