...
- Added PC/Tampermonkey-safe installation markers so the Hub can detect scripts even when isolated userscript sandboxes hide their APIs.
...
- SakaLuX Elimination Assistant **v1.3.8**
