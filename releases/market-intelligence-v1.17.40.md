...
Additional cache regression: a settled cached lookup immediately followed by a forced price/equipment refresh performs a new request; only actual overlapping network calls are coalesced.
